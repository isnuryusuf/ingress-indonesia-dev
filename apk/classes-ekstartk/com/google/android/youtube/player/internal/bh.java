...
public final class bh
{
  ...
  private static void a(Map<String, String> paramMap, String paramString)
  {
    ...
    do
    {
      ...
      {
        paramMap.put("error_initializing_player", "هنگام مقداردهی اولیه پخش‌کننده YouTube، خطایی روی داد.");
        paramMap.put("get_youtube_app_title", "دریافت برنامه YouTube");
        paramMap.put("get_youtube_app_text", "این برنامه بدون برنامه YouTube که در دستگاه شما موجود نیست، اجرا نمی‌شود");
        ...
        paramMap.put("update_youtube_app_title", "به‌روزرسانی برنامه YouTube");
        paramMap.put("update_youtube_app_text", "این برنامه کار نخواهد کرد مگر اینکه برنامه YouTube را به روز کنید.");
        paramMap.put("update_youtube_app_action", "به‌روزرسانی برنامه YouTube");
        return;
      }
