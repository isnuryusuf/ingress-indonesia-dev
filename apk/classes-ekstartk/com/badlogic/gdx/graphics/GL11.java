...
public abstract interface GL11 extends GL10
{
  ...
  public abstract void glColor4ub(byte paramByte1, byte paramByte2, byte paramByte3, byte paramByte4);
  ...
  public abstract void glDeleteBuffers(int paramInt1, int[] paramArrayOfInt, int paramInt2);
  ...
  public abstract void glGetBooleanv(int paramInt, IntBuffer paramIntBuffer);

  public abstract void glGetBooleanv(int paramInt1, boolean[] paramArrayOfBoolean, int paramInt2);

  public abstract void glGetBufferParameteriv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);

  public abstract void glGetBufferParameteriv(int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3);
  ...
  public abstract void glGetLightfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer);

  public abstract void glGetLightfv(int paramInt1, int paramInt2, float[] paramArrayOfFloat, int paramInt3);

  public abstract void glGetMaterialfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer);

  public abstract void glGetMaterialfv(int paramInt1, int paramInt2, float[] paramArrayOfFloat, int paramInt3);

  public abstract void glGetPointerv(int paramInt, Buffer[] paramArrayOfBuffer);

  public abstract void glGetTexEnviv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);

  public abstract void glGetTexEnviv(int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3);

  public abstract void glGetTexParameterfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer);

  public abstract void glGetTexParameterfv(int paramInt1, int paramInt2, float[] paramArrayOfFloat, int paramInt3);

  public abstract void glGetTexParameteriv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);

  public abstract void glGetTexParameteriv(int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3);
  ...
  public abstract void glNormalPointer(int paramInt1, int paramInt2, int paramInt3);

  public abstract void glPointParameterf(int paramInt, float paramFloat);

  public abstract void glPointParameterfv(int paramInt, FloatBuffer paramFloatBuffer);

  public abstract void glPointParameterfv(int paramInt1, float[] paramArrayOfFloat, int paramInt2);

  public abstract void glPointSizePointerOES(int paramInt1, int paramInt2, Buffer paramBuffer);

  public abstract void glTexCoordPointer(int paramInt1, int paramInt2, int paramInt3, int paramInt4);

  public abstract void glTexEnvi(int paramInt1, int paramInt2, int paramInt3);

  public abstract void glTexEnviv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);

  public abstract void glTexEnviv(int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3);
  ...
  public abstract void glTexParameteriv(int paramInt1, int paramInt2, int[] paramArrayOfInt, int paramInt3);

  public abstract void glVertexPointer(int paramInt1, int paramInt2, int paramInt3, int paramInt4);
}

/* Location:           classes_dex2jar.jar
 * Qualified Name:     com.badlogic.gdx.graphics.GL11
