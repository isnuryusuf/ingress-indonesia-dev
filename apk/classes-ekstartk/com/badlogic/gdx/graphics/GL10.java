...
public abstract interface GL10 extends GLCommon
{
  ...
  public abstract void glDeleteTextures(int paramInt1, int[] paramArrayOfInt, int paramInt2);
  ...
  public abstract void glFogfv(int paramInt, FloatBuffer paramFloatBuffer);

  public abstract void glFogfv(int paramInt1, float[] paramArrayOfFloat, int paramInt2);
  ...
  public abstract void glGenTextures(int paramInt1, int[] paramArrayOfInt, int paramInt2);
  ...
  public abstract void glLightModelfv(int paramInt, FloatBuffer paramFloatBuffer);

  public abstract void glLightModelfv(int paramInt1, float[] paramArrayOfFloat, int paramInt2);

  public abstract void glLightf(int paramInt1, int paramInt2, float paramFloat);

  public abstract void glLightfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer);

  public abstract void glLightfv(int paramInt1, int paramInt2, float[] paramArrayOfFloat, int paramInt3);
  ...
  public abstract void glMaterialfv(int paramInt1, int paramInt2, FloatBuffer paramFloatBuffer);

  public abstract void glMaterialfv(int paramInt1, int paramInt2, float[] paramArrayOfFloat, int paramInt3);
  ...
  public abstract void glPolygonMode(int paramInt1, int paramInt2);
 ...
 * Qualified Name:     com.badlogic.gdx.graphics.GL10
